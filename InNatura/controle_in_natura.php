...
$lista = [];
$sql = $conn->query("SELECT * FROM produtos_in_natura"); 
...
<h1>Controle de Produtos In Natura</h1>
...
<tr>
<td><?=$produtos['id'];?></td>
<td><?=$produtos['categoria_prod'];?></td>
<td><?=$produtos['qtde'];?></td>
<td><?=$produtos['temp_max'];?></td>
<td><?=date('d/m/Y',strtotime($produtos['data_entr']));?></td>
<td><?=date('d/m/Y',strtotime($produtos['data_sai']));?></td>
<td><?=$produtos['val'];?></td>
...
<td>
    ...
    <a href="cadastrar_in_natura.php?id=<//?=$produtos['id'];?>">
...
<td>
    <a href="editar_in_natura.php?id=<?=$produtos['id'];?>">
    <img class="del" src="../IMG/pen.png"></a>
</td>    

<td>
    <a class='trash3' href="excluir_in_natura.php?id=<?=$produtos['id'];?> ">
