...
if($id) {
    $sql = $conn->prepare("DELETE FROM  produtos_in_natura WHERE id = :id");
    $sql->bindValue('id', $id);
    ...
    header('Location: controle_in_natura.php'); // AQUI É que eu consiga ver a operação sendo feita, está página é responsavel, então vou ser redireciona pra a mesma.
